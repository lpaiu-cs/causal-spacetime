"""Provenance-aware preconditions for v3 protocol carry-forward evaluation."""
...
class V3ProtocolPreconditionReport:
...
def evaluate_v3_protocol_preconditions(
    manifest_dir: Path,
    bundle: dict[str, list[dict[str, str]]],
) -> list[V3ProtocolPreconditionReport]:
    """Evaluate admissibility metadata preconditions by v3 protocol family."""
    ...
    reports: list[V3ProtocolPreconditionReport] = []
    for family_name in families:
        ...
        reports.append(
            V3ProtocolPreconditionReport(
                ...
                report_only_controls_ineligible=controls_ineligible,
...
def v3_protocol_precondition_report_to_row(
    report: V3ProtocolPreconditionReport,
) -> dict[str, float | str]:
    """Convert one precondition report to a CSV row."""
...
def v3_protocol_precondition_summary(
    rows: list[dict[str, float | str]],
) -> list[dict[str, float | str]]:
    """Summarize precondition pass/fail counts by family kind."""
