"""Apply fixed M34 criteria to provenance-aware v3 protocol metrics."""
...
def v3_protocol_metrics_rows_from_bundle(
    bundle: dict[str, list[dict[str, str]]],
) -> list[dict[str, float | str]]:
    """Return v3 protocol metric rows from the M41 bundle."""
...
def v3_protocol_diagnostic_completeness_by_family(
    bundle: dict[str, list[dict[str, str]]],
) -> dict[str, bool]:
    """Return diagnostic-complete status by v3 protocol family."""
...
def decide_v3_protocol_family_robustness(
    ...
    """Apply fixed criteria with provenance-aware precondition gating."""
...
def v3_protocol_decision_to_row(
    ...
    *,
    ...
    """Convert one v3 protocol decision to a CSV row."""
