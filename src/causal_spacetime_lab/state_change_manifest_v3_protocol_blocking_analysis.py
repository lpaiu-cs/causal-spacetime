"""Blocked-decision root-cause audit utilities for v3 protocol families."""
...
class V3ProtocolBlockingRecord:
    """One criterion-level v3 protocol blocking record."""
...
def summarize_v3_protocol_blocking_records(
    records: list[V3ProtocolBlockingRecord],
) -> list[dict[str, float | str]]:
    """Summarize v3 protocol blocking records by root cause and status."""
