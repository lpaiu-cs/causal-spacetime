"""Apply fixed M34 criteria to the M44 v4 protocol bundle."""
...
from causal_spacetime_lab.state_change_manifest_v4_carry_forward import (
    ...
    v4_protocol_diagnostic_completeness_by_family,
...
from causal_spacetime_lab.state_change_manifest_v4_outputs import (
    ...
    missing_v4_protocol_bundle_inputs,
)
...
def parse_args() -> ExperimentConfig:
    parser = argparse.ArgumentParser(description="V4 protocol carry-forward decision.")
...
def save_figures(
    ...
    return [
        save_metric_bar(
            ...
            label_key="decision",
            value_key="count",
            path=output_dir / "figures" / "v4_protocol_decision_counts.png",
            ylabel="family count",
        ),
        save_metric_bar(
            heldout_rows,
            ...
            path=output_dir / "figures" / "v4_protocol_heldout_vs_decision.png",
...
def main() -> None:
    ...
    print("Wrote v4 protocol decisions: " + ", ".join(str(path) for path in paths))
