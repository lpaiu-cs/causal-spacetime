"""Count v3 protocol carry-forward decision outcomes and failed reasons."""
...
def parse_args() -> ExperimentConfig:
    parser = argparse.ArgumentParser(description="V3 protocol accounting.")
...
def main() -> None:
    ...
    path = write_csv(
        rows,
        data_path(config.output_dir, "v3_protocol_failed_provisional_accounting.csv"),
    ...
    figure = save_metric_bar(
        ...
        / "figures"
        / "v3_protocol_failed_provisional_counts.png",
        ylabel="family count",
    )
    print(f"Wrote v3 protocol accounting: {path}")
