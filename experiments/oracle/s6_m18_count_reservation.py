"""The S6 M=1.8 count campaign's seed reservation, in its own ref
namespace.
...
def probe_namespace() -> None:
    """Prove at PREFLIGHT that `refs/s6m18/` is writable: a NEW
    ...
    obj = _make_commit("s6m18 preflight probe")
    push = subprocess.run(
