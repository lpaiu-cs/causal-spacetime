"""Shared helpers for Milestone 42 v3 protocol carry-forward experiments."""
...
def read_v3_protocol_registry(output_dir: Path) -> CarryForwardRegistry | None:
    """Read the v3 protocol carry-forward registry if present."""
