...
- criteria for ranking reference-chain candidates without treating the
  top-scoring chain as a unique observer protocol,
...
- continuum-limit conditions and convergence rates,
- an account of density or metric-scale origin,
- dynamics rather than fixed kinematics,
- matter coupling,
- curvature and general relativity limits,
...
## Milestone 44 Obligations

Milestone 44 executes the preregistered v4 protocol manifest-generation run and
must show protocol-invariant profile construction, parameter-complete
measurement protocols, provenance-aware handoff manifests, and all required
