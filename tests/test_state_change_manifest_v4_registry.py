...
def test_build_v4_protocol_carry_forward_registry_serializes(
    tmp_path: Path,
    ...
    path = write_v4_protocol_carry_forward_registry(registry, tmp_path)

    payload = json.loads(path.read_text(encoding="utf-8"))
    assert payload["created_by_milestone"] == "Milestone 45"
